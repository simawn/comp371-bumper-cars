...
ModelCube::ModelCube(vec3 size) : Model()
{
...
void ModelCube::Update(float dt)
{
...
void ModelCube::Draw()
{
	...
	//GLuint WorldMatrixLocation = glGetUniformLocation(Shaders::currentShaderProgram, "worldMatrix"); 
	//glUniformMatrix4fv(WorldMatrixLocation, 1, GL_FALSE, &GetWorldMatrix()[0][0]);

	Renderer::setWorldMatrix(Shaders::currentShaderProgram, GetWorldMatrix());
	Renderer::setDiffuseColor(vec3(0.7, 0.0, 0.0));
